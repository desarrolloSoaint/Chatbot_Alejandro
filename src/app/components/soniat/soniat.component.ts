...
export class SoniatComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  tittleChatBox:string="ALEJANDRO";
  ...
  ngOnInit() {
    ...
    this.saveMessage("Hola me llamo ALEJANDRO y seré tu asesor durante la consulta, por favor coméntame ¿En qué puedo ayudarte?",false)
  }
  ngAfterViewInit(){
    this.scrollToBottom();
